...
# Leicht abgewandelt von https://github.com/gaston770/python-chord/blob/master/chord.py
...
# Daemon Klasse:
# Von https://github.com/gaston770/python-chord/blob/master/chord.py
...
class LocalNode(object):
    ...
    def start_daemons(self):
        # Idee ebenfalls von https://github.com/gaston770/python-chord/blob/master/chord.py
